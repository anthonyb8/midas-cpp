...
#include <string> // ADDED A.BAXTER

#if defined(_WIN32) || defined(_WIN64)
    // Windows-specific definition for DLL export/import
    #define TWSAPIDLLEXP __declspec(dllexport) // or __declspec(dllimport) as needed
#else
    // For macOS and other platforms, define it to nothing
    #define TWSAPIDLLEXP
#endif
